...
void test1() {
    ...
    for (auto it = s.begin(); it != s.end(); ++it) {
        std::cout << *it << " ";
#ifdef DEBUG
        std::cerr << "Enumerate: " << *it << std::endl;
        s.debug_print();
#endif
    }
    std::cout << std::endl;
...
void test3() {
    ...
    std::cout << *itl << " " << *itr << std::endl;          // 3 7
    std::cout << s.range(3, 8) << std::endl;                // 3
    s.emplace(4);
    std::cout << *(++itl) << " " << *(--itr) << std::endl;  // 4 5
    std::cout << s.range(3, 8) << std::endl;                // 4
    itl = s.begin(), itr = s.end();
    std::cout << ((--itl) == s.begin()) << " " << *itl << std::endl; // 1 1
